...
class peer_database:
    ...
    def start(self):
        explorer_krpc_v4_database_peer_database_append_peer_thread = threading.Thread(target = self.__append_peer)
        explorer_krpc_v4_database_peer_database_append_peer_thread.setDaemon(True)
        explorer_krpc_v4_database_peer_database_append_peer_thread.start()
        explorer_krpc_v4_database_peer_database_check_bad_peers_thread = threading.Thread(target = self.__check_bad_peers)
        explorer_krpc_v4_database_peer_database_check_bad_peers_thread.setDaemon(True)
        explorer_krpc_v4_database_peer_database_check_bad_peers_thread.start()
        explorer_krpc_v4_database_peer_database_check_empty_info_hashs_thread = threading.Thread(target = self.__check_empty_info_hashs)
        explorer_krpc_v4_database_peer_database_check_empty_info_hashs_thread.setDaemon(True)
        explorer_krpc_v4_database_peer_database_check_empty_info_hashs_thread.start()
        explorer_krpc_v4_database_peer_database_delete_peer_thread = threading.Thread(target = self.__delete_peer)
        explorer_krpc_v4_database_peer_database_delete_peer_thread.setDaemon(True)
        explorer_krpc_v4_database_peer_database_delete_peer_thread.start()
        explorer_krpc_v4_database_peer_database_query_info_hashes_thread = threading.Thread(target = self.__query_info_hashes)
        explorer_krpc_v4_database_peer_database_query_info_hashes_thread.setDaemon(True)
        explorer_krpc_v4_database_peer_database_query_info_hashes_thread.start()
        explorer_krpc_v4_database_peer_database_query_peers_thread = threading.Thread(target = self.__query_peers)
        explorer_krpc_v4_database_peer_database_query_peers_thread.setDaemon(True)
        explorer_krpc_v4_database_peer_database_query_peers_thread.start()