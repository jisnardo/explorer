...
class client:
    ...
    def __announce_peer_response(self):
        while True:
            ...
            if driver_control_announce_peer_messages[0] is False:
                ...
                nodes = driver_control_announce_peer_messages[1]
                ...
                for i in self.application_client_announce_peer_messages_key:
                    if i[0] == announce_peer_keyword:
                        if i[1] == 'application_command_announce_peer':
                            application_keyword = i[2]
                            self.application_client_announce_peer_messages_send_application_command_announce_peer.put(
                                [node_id, nodes, values, samples, token, ip_address, udp_port, application_keyword]
                            )
                        self.application_client_announce_peer_messages_operators.put(
                            ['remove', i]
                        )
    ...
    def __find_node_response(self):
        while True:
            ...
            if driver_control_find_node_messages[0] is False:
                ...
                nodes = driver_control_find_node_messages[1]
    ...
    def __get_peers_response(self):
        while True:
            ...
            if driver_control_get_peers_messages[0] is False:
                ...
                nodes = driver_control_get_peers_messages[1]
    ...
    def __ping_response(self):
        while True:
            ...
            if driver_control_ping_messages[0] is False:
                ...
                nodes = driver_control_ping_messages[1]
    ...
    def __sample_infohashes_response(self):
        while True:
            ...
            if driver_control_sample_infohashes_messages[0] is False:
                ...
                nodes = driver_control_sample_infohashes_messages[1]
    ...
    def start(self):
        explorer_krpc_v4_application_client_announce_peer_check_thread = threading.Thread(target = self.__announce_peer_check)
        explorer_krpc_v4_application_client_announce_peer_check_thread.setDaemon(True)
        explorer_krpc_v4_application_client_announce_peer_check_thread.start()
        explorer_krpc_v4_application_client_announce_peer_operators_thread = threading.Thread(target = self.__announce_peer_operators)
        explorer_krpc_v4_application_client_announce_peer_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_client_announce_peer_operators_thread.start()
        explorer_krpc_v4_application_client_announce_peer_request_thread = threading.Thread(target = self.__announce_peer_request)
        explorer_krpc_v4_application_client_announce_peer_request_thread.setDaemon(True)
        explorer_krpc_v4_application_client_announce_peer_request_thread.start()
        explorer_krpc_v4_application_client_announce_peer_response_thread = threading.Thread(target = self.__announce_peer_response)
        explorer_krpc_v4_application_client_announce_peer_response_thread.setDaemon(True)
        explorer_krpc_v4_application_client_announce_peer_response_thread.start()
        explorer_krpc_v4_application_client_find_node_check_thread = threading.Thread(target = self.__find_node_check)
        explorer_krpc_v4_application_client_find_node_check_thread.setDaemon(True)
        explorer_krpc_v4_application_client_find_node_check_thread.start()
        explorer_krpc_v4_application_client_find_node_operators_thread = threading.Thread(target = self.__find_node_operators)
        explorer_krpc_v4_application_client_find_node_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_client_find_node_operators_thread.start()
        explorer_krpc_v4_application_client_find_node_request_thread = threading.Thread(target = self.__find_node_request)
        explorer_krpc_v4_application_client_find_node_request_thread.setDaemon(True)
        explorer_krpc_v4_application_client_find_node_request_thread.start()
        explorer_krpc_v4_application_client_find_node_response_thread = threading.Thread(target = self.__find_node_response)
        explorer_krpc_v4_application_client_find_node_response_thread.setDaemon(True)
        explorer_krpc_v4_application_client_find_node_response_thread.start()
        explorer_krpc_v4_application_client_get_peers_check_thread = threading.Thread(target = self.__get_peers_check)
        explorer_krpc_v4_application_client_get_peers_check_thread.setDaemon(True)
        explorer_krpc_v4_application_client_get_peers_check_thread.start()
        explorer_krpc_v4_application_client_get_peers_operators_thread = threading.Thread(target = self.__get_peers_operators)
        explorer_krpc_v4_application_client_get_peers_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_client_get_peers_operators_thread.start()
        explorer_krpc_v4_application_client_get_peers_request_thread = threading.Thread(target = self.__get_peers_request)
        explorer_krpc_v4_application_client_get_peers_request_thread.setDaemon(True)
        explorer_krpc_v4_application_client_get_peers_request_thread.start()
        explorer_krpc_v4_application_client_get_peers_response_thread = threading.Thread(target = self.__get_peers_response)
        explorer_krpc_v4_application_client_get_peers_response_thread.setDaemon(True)
        explorer_krpc_v4_application_client_get_peers_response_thread.start()
        explorer_krpc_v4_application_client_ping_check_thread = threading.Thread(target = self.__ping_check)
        explorer_krpc_v4_application_client_ping_check_thread.setDaemon(True)
        explorer_krpc_v4_application_client_ping_check_thread.start()
        explorer_krpc_v4_application_client_ping_operators_thread = threading.Thread(target = self.__ping_operators)
        explorer_krpc_v4_application_client_ping_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_client_ping_operators_thread.start()
        explorer_krpc_v4_application_client_ping_request_thread = threading.Thread(target = self.__ping_request)
        explorer_krpc_v4_application_client_ping_request_thread.setDaemon(True)
        explorer_krpc_v4_application_client_ping_request_thread.start()
        explorer_krpc_v4_application_client_ping_response_thread = threading.Thread(target = self.__ping_response)
        explorer_krpc_v4_application_client_ping_response_thread.setDaemon(True)
        explorer_krpc_v4_application_client_ping_response_thread.start()
        explorer_krpc_v4_application_client_sample_infohashes_check_thread = threading.Thread(target = self.__sample_infohashes_check)
        explorer_krpc_v4_application_client_sample_infohashes_check_thread.setDaemon(True)
        explorer_krpc_v4_application_client_sample_infohashes_check_thread.start()
        explorer_krpc_v4_application_client_sample_infohashes_operators_thread = threading.Thread(target = self.__sample_infohashes_operators)
        explorer_krpc_v4_application_client_sample_infohashes_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_client_sample_infohashes_operators_thread.start()
        explorer_krpc_v4_application_client_sample_infohashes_request_thread = threading.Thread(target = self.__sample_infohashes_request)
        explorer_krpc_v4_application_client_sample_infohashes_request_thread.setDaemon(True)
        explorer_krpc_v4_application_client_sample_infohashes_request_thread.start()
        explorer_krpc_v4_application_client_sample_infohashes_response_thread = threading.Thread(target = self.__sample_infohashes_response)
        explorer_krpc_v4_application_client_sample_infohashes_response_thread.setDaemon(True)
        explorer_krpc_v4_application_client_sample_infohashes_response_thread.start()