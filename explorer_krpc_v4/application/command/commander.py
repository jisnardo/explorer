...
class commander:
    ...
    def start(self):
        explorer_krpc_v4_application_command_commander_announce_peer_operators_thread = threading.Thread(target = self.__announce_peer_operators)
        explorer_krpc_v4_application_command_commander_announce_peer_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_announce_peer_operators_thread.start()
        explorer_krpc_v4_application_command_commander_announce_peer_request_thread = threading.Thread(target = self.__announce_peer_request)
        explorer_krpc_v4_application_command_commander_announce_peer_request_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_announce_peer_request_thread.start()
        explorer_krpc_v4_application_command_commander_announce_peer_response_thread = threading.Thread(target = self.__announce_peer_response)
        explorer_krpc_v4_application_command_commander_announce_peer_response_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_announce_peer_response_thread.start()
        explorer_krpc_v4_application_command_commander_find_node_operators_thread = threading.Thread(target = self.__find_node_operators)
        explorer_krpc_v4_application_command_commander_find_node_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_find_node_operators_thread.start()
        explorer_krpc_v4_application_command_commander_find_node_request_thread = threading.Thread(target = self.__find_node_request)
        explorer_krpc_v4_application_command_commander_find_node_request_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_find_node_request_thread.start()
        explorer_krpc_v4_application_command_commander_find_node_response_thread = threading.Thread(target = self.__find_node_response)
        explorer_krpc_v4_application_command_commander_find_node_response_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_find_node_response_thread.start()
        explorer_krpc_v4_application_command_commander_get_peers_operators_thread = threading.Thread(target = self.__get_peers_operators)
        explorer_krpc_v4_application_command_commander_get_peers_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_get_peers_operators_thread.start()
        explorer_krpc_v4_application_command_commander_get_peers_request_thread = threading.Thread(target = self.__get_peers_request)
        explorer_krpc_v4_application_command_commander_get_peers_request_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_get_peers_request_thread.start()
        explorer_krpc_v4_application_command_commander_get_peers_response_thread = threading.Thread(target = self.__get_peers_response)
        explorer_krpc_v4_application_command_commander_get_peers_response_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_get_peers_response_thread.start()
        explorer_krpc_v4_application_command_commander_ping_operators_thread = threading.Thread(target = self.__ping_operators)
        explorer_krpc_v4_application_command_commander_ping_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_ping_operators_thread.start()
        explorer_krpc_v4_application_command_commander_ping_request_thread = threading.Thread(target = self.__ping_request)
        explorer_krpc_v4_application_command_commander_ping_request_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_ping_request_thread.start()
        explorer_krpc_v4_application_command_commander_ping_response_thread = threading.Thread(target = self.__ping_response)
        explorer_krpc_v4_application_command_commander_ping_response_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_ping_response_thread.start()
        explorer_krpc_v4_application_command_commander_sample_infohashes_operators_thread = threading.Thread(target = self.__sample_infohashes_operators)
        explorer_krpc_v4_application_command_commander_sample_infohashes_operators_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_sample_infohashes_operators_thread.start()
        explorer_krpc_v4_application_command_commander_sample_infohashes_request_thread = threading.Thread(target = self.__sample_infohashes_request)
        explorer_krpc_v4_application_command_commander_sample_infohashes_request_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_sample_infohashes_request_thread.start()
        explorer_krpc_v4_application_command_commander_sample_infohashes_response_thread = threading.Thread(target = self.__sample_infohashes_response)
        explorer_krpc_v4_application_command_commander_sample_infohashes_response_thread.setDaemon(True)
        explorer_krpc_v4_application_command_commander_sample_infohashes_response_thread.start()