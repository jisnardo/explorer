                            ...
                            for j in last_query_nodes:
                                ...
                                if nodes_distance[0] == int(target_id, 16) ^ int(nodes_node_id, 16):
                                    ...
                                    client.application_client_find_node_messages_recvfrom.put(
                                        ['application_command_find_node', target_id, nodes_ip_address, nodes_udp_port, application_command_find_node_keyword]
                                    )
                                    self.application_command_find_node_operators.put(
                                        ['append', [application_command_find_node_keyword, target_id, nodes_node_id, nodes_ip_address, nodes_udp_port, last_query_nodes, response_nodes, application_command_commander_keyword, int(time.time())]]
                                    )
            else:
                node_id = application_client_find_node_messages_send_application_command_find_node[0]
                nodes = application_client_find_node_messages_send_application_command_find_node[1]
                                    ...
                                    for j in nodes:
                                        ...
                                        if nodes_distance[0] == int(target_id, 16) ^ int(nodes_node_id, 16):
                                            if distance > nodes_distance[0]:
                                                ...
                                                self.application_command_find_node_operators.put(
                                                    ['append', [application_command_find_node_keyword, target_id, nodes_node_id, nodes_ip_address, nodes_udp_port, nodes, response_nodes, application_command_commander_keyword, int(time.time())]]
                                                )
                                            else:
                                                result = {
                                                    'result': True,
