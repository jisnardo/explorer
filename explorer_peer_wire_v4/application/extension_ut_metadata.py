...
class extension_ut_metadata:
    ...
    def start(self):
        explorer_peer_wire_v4_application_extension_ut_metadata_operators_thread = threading.Thread(target = self.__operators)
        explorer_peer_wire_v4_application_extension_ut_metadata_operators_thread.setDaemon(True)
        explorer_peer_wire_v4_application_extension_ut_metadata_operators_thread.start()
        explorer_peer_wire_v4_application_extension_ut_metadata_recvfrom_thread = threading.Thread(target = self.__recvfrom)
        explorer_peer_wire_v4_application_extension_ut_metadata_recvfrom_thread.setDaemon(True)
        explorer_peer_wire_v4_application_extension_ut_metadata_recvfrom_thread.start()
        explorer_peer_wire_v4_application_extension_ut_metadata_send_thread = threading.Thread(target = self.__send)
        explorer_peer_wire_v4_application_extension_ut_metadata_send_thread.setDaemon(True)
        explorer_peer_wire_v4_application_extension_ut_metadata_send_thread.start()