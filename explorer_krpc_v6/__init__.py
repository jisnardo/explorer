...
def announce_peer(info_hash, tcp_port):
    ...
    explorer_krpc_v6.announce_peer()
...
def get_peers(info_hash):
    ...
    Returns:
        ...
        {
            'result': [['2001:4860:4860::8844', 51413], ['2001:4860:4860::8888', 6881]],
            'header': {
...
def query_announce_info_hashes():
    ...
    explorer_krpc_v6.query_announce_info_hashes()
    ...
    Returns:
...

        {
            '59abaad8e68806ebac108bd69b13d7e9a38be5fb': [
                ['2001:4860:4860::8844', 51413, 1666969066]
            ],
            'cf0a537944c001ad86b1ca058e8d877f5f022fc6': [
                ['2001:4860:4860::8888', 6881, 1666969123]
            ]
        }
...
def query_get_peers_info_hashes():
    ...
    explorer_krpc_v6.query_get_peers_info_hashes()
...
def query_nodes_number():
    ...
    explorer_krpc_v6.query_nodes_number()
...
def sample_infohashes(target_id):
    ...
    explorer_krpc_v6.sample_infohashes()
...
def self_ip_address():
    ...
    explorer_krpc_v6.self_ip_address()
...
def self_udp_port():
    ...
    explorer_krpc_v6.self_udp_port()
