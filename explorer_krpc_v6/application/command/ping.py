...
class ping:
    ...
    def start(self):
        explorer_krpc_v6_application_command_ping_check_thread = threading.Thread(target = self.__check)
        explorer_krpc_v6_application_command_ping_check_thread.setDaemon(True)
        explorer_krpc_v6_application_command_ping_check_thread.start()
        explorer_krpc_v6_application_command_ping_operators_thread = threading.Thread(target = self.__operators)
        explorer_krpc_v6_application_command_ping_operators_thread.setDaemon(True)
        explorer_krpc_v6_application_command_ping_operators_thread.start()
        explorer_krpc_v6_application_command_ping_recvfrom_thread = threading.Thread(target = self.__recvfrom)
        explorer_krpc_v6_application_command_ping_recvfrom_thread.setDaemon(True)
        explorer_krpc_v6_application_command_ping_recvfrom_thread.start()
        explorer_krpc_v6_application_command_ping_send_thread = threading.Thread(target = self.__send)
        explorer_krpc_v6_application_command_ping_send_thread.setDaemon(True)
        explorer_krpc_v6_application_command_ping_send_thread.start()