                            ...
                            for j in last_query_nodes:
                                ...
                                if nodes6_distance[0] == int(target_id, 16) ^ int(nodes6_node_id, 16):
                                    ...
                                    client.application_client_sample_infohashes_messages_recvfrom.put(
                                        ['application_command_sample_infohashes', target_id, nodes6_ip_address, nodes6_udp_port, application_command_sample_infohashes_keyword]
                                    )
                                    self.application_command_sample_infohashes_operators.put(
                                        ['append', [application_command_sample_infohashes_keyword, target_id, nodes6_node_id, nodes6_ip_address, nodes6_udp_port, last_query_nodes, response_nodes, response_samples, application_command_commander_keyword, int(time.time())]]
                                    )
            else:
                node_id = application_client_sample_infohashes_messages_send_application_command_sample_infohashes[0]
                nodes6 = application_client_sample_infohashes_messages_send_application_command_sample_infohashes[1]
                                    ...
                                    for j in nodes6:
                                        ...
                                        if nodes6_distance[0] == int(target_id, 16) ^ int(nodes6_node_id, 16):
                                            if distance > nodes6_distance[0]:
                                                ...
                                                self.application_command_sample_infohashes_operators.put(
                                                    ['append', [application_command_sample_infohashes_keyword, target_id, nodes6_node_id, nodes6_ip_address, nodes6_udp_port, nodes6, response_nodes, response_samples, application_command_commander_keyword, int(time.time())]]
                                                )
                                            else:
                                                result = {
                                                    'result': response_samples,
