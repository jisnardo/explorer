...
class error:
    ...
    def start(self):
        explorer_krpc_v6_application_error_recvfrom_thread = threading.Thread(target = self.__recvfrom)
        explorer_krpc_v6_application_error_recvfrom_thread.setDaemon(True)
        explorer_krpc_v6_application_error_recvfrom_thread.start()