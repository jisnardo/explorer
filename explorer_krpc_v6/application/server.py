...
class server:
    ...
    def start(self):
        explorer_krpc_v6_application_server_check_request_info_hash_thread = threading.Thread(target = self.__check_request_info_hash)
        explorer_krpc_v6_application_server_check_request_info_hash_thread.setDaemon(True)
        explorer_krpc_v6_application_server_check_request_info_hash_thread.start()
