...
class recvfrom:
    ...
    def start_listen(self):
        explorer_krpc_v6_driver_abstraction_recvfrom_check_query_nodes_time_thread = threading.Thread(target = self.__check_query_nodes_time)
        explorer_krpc_v6_driver_abstraction_recvfrom_check_query_nodes_time_thread.setDaemon(True)
        explorer_krpc_v6_driver_abstraction_recvfrom_check_query_nodes_time_thread.start()
        explorer_krpc_v6_driver_abstraction_recvfrom_check_query_nodes_time_operators_thread = threading.Thread(target = self.__check_query_nodes_time_operators)
        explorer_krpc_v6_driver_abstraction_recvfrom_check_query_nodes_time_operators_thread.setDaemon(True)
        explorer_krpc_v6_driver_abstraction_recvfrom_check_query_nodes_time_operators_thread.start()
