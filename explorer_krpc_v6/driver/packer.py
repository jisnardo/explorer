...
class krpc_response_messages:
    def announce_peer(self, transaction_id, node_id, ip_address, udp_port):
        message = {
            'ip': socket.inet_pton(socket.AF_INET6, ip_address),
            't': transaction_id,
            'y': 'r',
            'r':
            {
    ...
    def find_node(self, transaction_id, node_id, nodes6, ip_address, udp_port):
        message = {
            'ip': socket.inet_pton(socket.AF_INET6, ip_address),
            't': transaction_id,
            'y': 'r',
    ...
    def get_peers(self, transaction_id, node_id, nodes6, values, token, ip_address, udp_port):
        message = {
            'ip': socket.inet_pton(socket.AF_INET6, ip_address),
            't': transaction_id,
            'y': 'r',
    ...
    def sample_infohashes(self, transaction_id, node_id, nodes6, number, samples, ip_address, udp_port):
        message = {
            'ip': socket.inet_pton(socket.AF_INET6, ip_address),
            't': transaction_id,
            'y': 'r',
