...
class token_manager:
    ...
    def start(self):
        explorer_krpc_v6_database_token_manager_append_token_thread = threading.Thread(target = self.__append_token)
        explorer_krpc_v6_database_token_manager_append_token_thread.setDaemon(True)
        explorer_krpc_v6_database_token_manager_append_token_thread.start()
        explorer_krpc_v6_database_token_manager_check_bad_token_thread = threading.Thread(target = self.__check_bad_token)
        explorer_krpc_v6_database_token_manager_check_bad_token_thread.setDaemon(True)
        explorer_krpc_v6_database_token_manager_check_bad_token_thread.start()
        explorer_krpc_v6_database_token_manager_query_token_thread = threading.Thread(target = self.__query_token)
        explorer_krpc_v6_database_token_manager_query_token_thread.setDaemon(True)
        explorer_krpc_v6_database_token_manager_query_token_thread.start()