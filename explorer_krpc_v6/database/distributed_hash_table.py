...
class distributed_hash_table:
    ...
    def __confirm_nodes_time_find_node(self):
        while True:
            ...
            if database_find_node_messages_send[0] is False:
                ...
                nodes6 = database_find_node_messages_send[1]
    ...
    def start(self):
        ...
        explorer_krpc_v6_database_distributed_hash_table_check_database_binary_tree_thread = threading.Thread(target = self.__check_database_binary_tree)
        explorer_krpc_v6_database_distributed_hash_table_check_database_binary_tree_thread.setDaemon(True)
        explorer_krpc_v6_database_distributed_hash_table_check_database_binary_tree_thread.start()
        ...
        explorer_krpc_v6_database_distributed_hash_table_delete_node_with_ip_address_thread = threading.Thread(target = self.__delete_node_with_ip_address)
        explorer_krpc_v6_database_distributed_hash_table_delete_node_with_ip_address_thread.setDaemon(True)
        explorer_krpc_v6_database_distributed_hash_table_delete_node_with_ip_address_thread.start()
        explorer_krpc_v6_database_distributed_hash_table_delete_node_with_node_id_thread = threading.Thread(target = self.__delete_node_with_node_id)
        explorer_krpc_v6_database_distributed_hash_table_delete_node_with_node_id_thread.setDaemon(True)
        explorer_krpc_v6_database_distributed_hash_table_delete_node_with_node_id_thread.start()
        explorer_krpc_v6_database_distributed_hash_table_query_node_with_ip_address_thread = threading.Thread(target = self.__query_node_with_ip_address)
        explorer_krpc_v6_database_distributed_hash_table_query_node_with_ip_address_thread.setDaemon(True)
        explorer_krpc_v6_database_distributed_hash_table_query_node_with_ip_address_thread.start()
        explorer_krpc_v6_database_distributed_hash_table_query_node_with_node_id_thread = threading.Thread(target = self.__query_node_with_node_id)
        explorer_krpc_v6_database_distributed_hash_table_query_node_with_node_id_thread.setDaemon(True)
        explorer_krpc_v6_database_distributed_hash_table_query_node_with_node_id_thread.start()
