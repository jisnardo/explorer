...
class udp_tracker_scrape:
    ...
    def start(self):
        explorer_udp_tracker_application_udp_tracker_scrape_operators_thread = threading.Thread(target = self.__operators)
        explorer_udp_tracker_application_udp_tracker_scrape_operators_thread.setDaemon(True)
        explorer_udp_tracker_application_udp_tracker_scrape_operators_thread.start()
        explorer_udp_tracker_application_udp_tracker_scrape_recvfrom_thread = threading.Thread(target = self.__recvfrom)
        explorer_udp_tracker_application_udp_tracker_scrape_recvfrom_thread.setDaemon(True)
        explorer_udp_tracker_application_udp_tracker_scrape_recvfrom_thread.start()
        explorer_udp_tracker_application_udp_tracker_scrape_send_thread = threading.Thread(target = self.__send)
        explorer_udp_tracker_application_udp_tracker_scrape_send_thread.setDaemon(True)
        explorer_udp_tracker_application_udp_tracker_scrape_send_thread.start()