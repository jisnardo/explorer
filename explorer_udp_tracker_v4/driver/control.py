...
class control:
    ...
    def __announce_completed_recvfrom(self):
        while True:
            ...
            explorer_udp_tracker_v4_driver_control_announce_completed_send_thread = threading.Thread(target = self.__announce_completed_send, args = (ip_address, udp_port, info_hash, uploaded, downloaded, left, tcp_port, application_http_tracker_announce_completed_keyword,))
            explorer_udp_tracker_v4_driver_control_announce_completed_send_thread.setDaemon(True)
            explorer_udp_tracker_v4_driver_control_announce_completed_send_thread.start()
    ...
    def __announce_none_recvfrom(self):
        while True:
            ...
            explorer_udp_tracker_v4_driver_control_announce_none_send_thread = threading.Thread(target = self.__announce_none_send, args = (ip_address, udp_port, info_hash, downloaded, left, uploaded, tcp_port, application_http_tracker_announce_none_keyword,))
            explorer_udp_tracker_v4_driver_control_announce_none_send_thread.setDaemon(True)
            explorer_udp_tracker_v4_driver_control_announce_none_send_thread.start()
    ...
    def __announce_started_recvfrom(self):
        while True:
            ...
            explorer_udp_tracker_v4_driver_control_announce_started_send_thread = threading.Thread(target = self.__announce_started_send, args = (ip_address, udp_port, info_hash, downloaded, left, uploaded, tcp_port, application_http_tracker_announce_started_keyword,))
            explorer_udp_tracker_v4_driver_control_announce_started_send_thread.setDaemon(True)
            explorer_udp_tracker_v4_driver_control_announce_started_send_thread.start()
    ...
    def __announce_stopped_recvfrom(self):
        while True:
            ...
            explorer_udp_tracker_v4_driver_control_announce_stopped_send_thread = threading.Thread(target = self.__announce_stopped_send, args = (ip_address, udp_port, info_hash, downloaded, left, uploaded, tcp_port, application_http_tracker_announce_stopped_keyword,))
            explorer_udp_tracker_v4_driver_control_announce_stopped_send_thread.setDaemon(True)
            explorer_udp_tracker_v4_driver_control_announce_stopped_send_thread.start()
    ...
    def __scrape_recvfrom(self):
        while True:
            ...
            explorer_udp_tracker_v4_driver_control_scrape_send_thread = threading.Thread(target = self.__scrape_send, args = (ip_address, udp_port, info_hash, application_http_tracker_scrape_keyword))
            explorer_udp_tracker_v4_driver_control_scrape_send_thread.setDaemon(True)
            explorer_udp_tracker_v4_driver_control_scrape_send_thread.start()
    ...
    def start(self):
        explorer_udp_tracker_v4_driver_control_announce_completed_recvfrom_thread = threading.Thread(target = self.__announce_completed_recvfrom)
        explorer_udp_tracker_v4_driver_control_announce_completed_recvfrom_thread.setDaemon(True)
        explorer_udp_tracker_v4_driver_control_announce_completed_recvfrom_thread.start()
        explorer_udp_tracker_v4_driver_control_announce_none_recvfrom_thread = threading.Thread(target = self.__announce_none_recvfrom)
        explorer_udp_tracker_v4_driver_control_announce_none_recvfrom_thread.setDaemon(True)
        explorer_udp_tracker_v4_driver_control_announce_none_recvfrom_thread.start()
        explorer_udp_tracker_v4_driver_control_announce_started_recvfrom_thread = threading.Thread(target = self.__announce_started_recvfrom)
        explorer_udp_tracker_v4_driver_control_announce_started_recvfrom_thread.setDaemon(True)
        explorer_udp_tracker_v4_driver_control_announce_started_recvfrom_thread.start()
        explorer_udp_tracker_v4_driver_control_announce_stopped_recvfrom_thread = threading.Thread(target = self.__announce_stopped_recvfrom)
        explorer_udp_tracker_v4_driver_control_announce_stopped_recvfrom_thread.setDaemon(True)
        explorer_udp_tracker_v4_driver_control_announce_stopped_recvfrom_thread.start()
        explorer_udp_tracker_v4_driver_control_scrape_recvfrom_thread = threading.Thread(target = self.__scrape_recvfrom)
        explorer_udp_tracker_v4_driver_control_scrape_recvfrom_thread.setDaemon(True)
        explorer_udp_tracker_v4_driver_control_scrape_recvfrom_thread.start()