...
class transmission:
    ...
    def __extension_ut_metadata_recvfrom(self):
        while True:
            ...
            ipv4_address = driver_transmission_extension_ut_metadata_messages_recvfrom[6]
            ipv4_udp_port = driver_transmission_extension_ut_metadata_messages_recvfrom[7]
            application_extension_ut_metadata_keyword = driver_transmission_extension_ut_metadata_messages_recvfrom[8]
            explorer_peer_wire_v6_driver_transmission_extension_ut_metadata_send_thread = threading.Thread(target = self.__extension_ut_metadata_send, args = (socket_server, info_hash, ip_address, tcp_port, ut_metadata, metadata_size, ipv4_address, ipv4_udp_port, application_extension_ut_metadata_keyword))
            explorer_peer_wire_v6_driver_transmission_extension_ut_metadata_send_thread.setDaemon(True)
            explorer_peer_wire_v6_driver_transmission_extension_ut_metadata_send_thread.start()

    def __extension_ut_metadata_send(self, socket_server, info_hash, ip_address, tcp_port, ut_metadata, metadata_size, ipv4_address, ipv4_udp_port, application_extension_ut_metadata_keyword):
    ...
    def start(self):
        explorer_peer_wire_v6_driver_transmission_check_outdated_extension_ut_metadata_progress_messages_thread = threading.Thread(target = self.__check_outdated_extension_ut_metadata_progress_messages)
        explorer_peer_wire_v6_driver_transmission_check_outdated_extension_ut_metadata_progress_messages_thread.setDaemon(True)
        explorer_peer_wire_v6_driver_transmission_check_outdated_extension_ut_metadata_progress_messages_thread.start()
        explorer_peer_wire_v6_driver_transmission_extension_ut_metadata_recvfrom_thread = threading.Thread(target = self.__extension_ut_metadata_recvfrom)
        explorer_peer_wire_v6_driver_transmission_extension_ut_metadata_recvfrom_thread.setDaemon(True)
        explorer_peer_wire_v6_driver_transmission_extension_ut_metadata_recvfrom_thread.start()